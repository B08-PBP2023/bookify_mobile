...
class WishlistSaya extends StatefulWidget {
  const WishlistSaya({super.key,required this.userId});
  final int userId;

  @override
  State<WishlistSaya> createState() => _WishlistSayaState();
}

class _WishlistSayaState extends State<WishlistSaya> {
  bool value = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text("Daftar Wishlist Saya",),
        ),
        ...
        body: Container(
          ...
          child: FutureBuilder(
              future: fetchWishlistModel(userId),
